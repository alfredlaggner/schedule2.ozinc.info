 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\User whereNexmoId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\User wherePassword($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\User wherePhoneNumber($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\User whereRememberToken($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\User whereSalesPersonId($value)
...
class User extends Authenticatable
{
  ...
  //  protected $table = 'drivers';
    ...
    protected $fillable = ['sales_person_id',
        'name', 'email', 'password','first_name','last_name', 'phone_number', 'user_type','is_ten_ninety'
    ];
