...
//dd("test");
        ...
        for ($i = 0; $i < count($order_lines); $i++) {
            ...
            SaleInvoice::updateOrCreate(
                ...
                [
                    ...
                    'amount' => $order_lines[$i]['product_uom_qty'] * $order_lines[$i]['price_unit'],
                    'cost' => $order_lines[$i]['purchase_price'],
        ...
        $sis = SaleInvoice::select('saleinvoices.ext_id as eext_id',
            ...
            'salesorders.confirmation_date as confirmation_date',
            'salesorders.order_date_stamped as order_date_stamped',
            ...
            ->leftJoin('product_products', 'product_products.ext_id', '=', 'saleinvoices.product_id')
            ->leftJoin('sales_persons', 'sales_persons.sales_person_id', '=', 'saleinvoices.sales_person_id')
            ->leftJoin('salesorders', 'salesorders.ext_id', '=', 'saleinvoices.order_id')
   ...
   //         $this->info($cat_length);
            ...
            SaleInvoice::where('id', $sid)
                ->update([
                    ...
                    'order_date_stamped' => $si->order_date_stamped,
                    'amt_to_invoice' => $si->to_invoice,
                    'amt_invoiced' => $si->invoiced,
                    'confirmation_date' =>$si->confirmation_date,
                    'category_full' => $si->product_category_full,
                    'cat_sub1' => $cat_sub1,
                    'cat_sub2' => $cat_sub2,
                    'cat_sub3' => $cat_sub3,
                    'cat_sub4' => $cat_sub4,
